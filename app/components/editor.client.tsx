...
export type CustomElement = { id: string, type: 'p'; children: CustomText[] }
...
interface PlateEditorProps {
    onChangeFn: (value: CustomElement[]) => void;
    initialValueForm?: CustomElement[];
}

export function PlateEditor(props: PlateEditorProps) {
    const {onChangeFn, initialValueForm} = props;
    return (
        <TooltipProvider>
            <DndProvider backend={HTML5Backend}>
                <CommentsProvider users={{}} myUserId="1">
                    <Plate plugins={plugins} initialValue={initialValueForm ? initialValueForm : initialValue} onChange={onChangeFn}>
                        <FixedToolbar>
                            <FixedToolbarButtons />
                        </FixedToolbar>
                        <Editor />
